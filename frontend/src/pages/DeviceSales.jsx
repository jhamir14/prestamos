...
import api from '../api';
import { Plus, ShoppingCart, Calendar, Trash2, Eye, X } from 'lucide-react';
                        ...
                        {sales.map(sale => (
                            <tr key={sale.id} className="hover:bg-gray-50 dark:hover:bg-gray-700 text-gray-900 dark:text-gray-300">
                                ...
                                <td className="p-4 flex space-x-2">
                                    ...
                                    {sale.tipo === 'Credito' && (
                                        <button onClick={() => handleOpenCalendar(sale)} className="text-green-600 hover:text-green-800 dark:text-green-400 dark:hover:text-green-300">
