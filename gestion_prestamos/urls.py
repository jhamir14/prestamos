...
urlpatterns = [
    ...
    path('editar-prestamo/<int:prestamo_id>/', views.editar_prestamo, name='editar_prestamo'),
    ...
    path('desmarcar-cuota-pagada/<int:cuota_id>/', views.desmarcar_cuota_pagada, name='desmarcar_cuota_pagada'),
